...
*   `notebooks/`: Il Jupyter Notebook in cui sono esplicitate le fasi di costruzione del software.
*   `README.md`: Questa guida descrittiva.

## Metodologia e Fasi del Lavoro

Per il progetto sono state analizzate le specifiche fornite ed è stata dedicata una sezione per ogni funzionalità richiesta.

Al momento di riunire le funzioni, è stato poi eseguita una simulazione di messa in produzione del software su un caso d'uso reale per testarne le funzionalità.
